...
public class MacroStartegy : SaceShips.Lib.Interfaces.IStartegy
{
    ...
    public object execute(object[] args)
    {
        ...
        var x = Hwdtech.IoC.Resolve<List<KeyValuePair<SaceShips.Lib.Interfaces.IStartegy, object[]>>>("SpaceShip.Lib.Get.KeyPairStrategyParamsList", strategies.Zip((List<object[]>)args[1], (a, b) => Hwdtech.IoC.Resolve<KeyValuePair<SaceShips.Lib.Interfaces.IStartegy, object[]>>("SpaceShip.Lib.Get.KeyPairStrategyParams", a, b)));
