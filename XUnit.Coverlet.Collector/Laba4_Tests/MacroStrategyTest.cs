...
public class MacroStartegyTest
{
    ...
    public void Init_Score_Env_1t()
    {
        ...
        Hwdtech.IoC.Resolve<Hwdtech.ICommand>("IoC.Register", "SpaceShip.Lib.Get.KeyPairStrategyParams", (object[] args) => (object)(new KeyValuePair<SaceShips.Lib.Interfaces.IStartegy, object[]>())).Execute();
